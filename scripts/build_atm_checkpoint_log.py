...
SESSIONS = [
    ...
    {
        "id": "sep11-calls",
        "title": "Sep 11, 2026 — ATM Calls through 10:30 (25 names)",
        "file": "sep11_2026_atm_call_checkpoints.csv",
        "right": "call",
        "blurb": "HPE, DELL, SWKS, AXSM, BE, WF, STRL, SOXL, COHR, IESC, SMTC, HPQ, FLEX, MRVL, CIEN, KB, AEIS, NTAP, ONTO, FORM, ANET, TTMI, QCOM, HUT, INTC. 12:30 left empty.",
        "cols": [
            ("ticker", "Ticker"),
            ("expiry", "Expiry"),
            ("spot_935", "9:35 stock"),
...
def ensure_total_row(rows: list[dict], *, right: str) -> list[dict]:
    ...
    total = {
        ...
        "opt_1030": _sum_field(data, "opt_1030"),
        "opt_1230": _sum_field(data, "opt_1230"),
        "opt_1530": _sum_field(data, "opt_1530"),
        "opt_1030_bar": "",
        "opt_1230_bar": "",
        "opt_1530_bar": "",
        "pct_935_to_945": _paired_pct(data, "opt_935", "opt_945"),
        "pct_935_to_1030": _paired_pct(data, "opt_935", "opt_1030"),
